...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="col-md-9 d-dash-content pl-5">
            ...
            <!-- main tables -->
            <div class="docDetailsTable ">
                <h5>Appoinment Details</h5>
                <div class=""> 
                    <nav class="nav d-flex justify-content-around py-2">
                        <button class="btn px-4  active ">Appointments</button>
                        <button class="btn px-4  ">Prescriptions</button>
                        <button class="btn px-4 ">Medical_Records</button>
                        <button class="btn px-4   ">Billing</button>
                    </nav>
                </div>
                <div class="my-3 all-table">

                    <!-- Appointments -->
                    <div class="Appointments  table-responsive ">
                    ...
                    <!-- Prescriptions -->
                    <div class=" Prescriptions table-responsive">
                        <table class="table  " id="">
                            <thead>
                                <tr>
                    ...
                    <!-- Medical Records -->
                    <div class=" Medical_Records table-responsive">
                        <table class="table " id="">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                    ...
                    <!-- Medical Records -->
                    <div class=" Billing table-responsive">
                        <table class="table" id="">
                            <thead>
                                <tr>
        ...
        <!-- <div class="col-md-3 side-profile p-2 border">
            <div class="">
                <div class="d-flex justify-content-center mb-4">
                    <img src="/image/pat-img/default_user.png" height="150" class="rounded-circle" alt="">
                </div>
