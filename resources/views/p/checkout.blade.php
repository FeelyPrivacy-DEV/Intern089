...
if ($_SESSION['eid'] == '') {
    header('location: http://127.0.0.1/s/s/index');
}
...
<head>
    ...
    <link rel="stylesheet" href="/css/p-checkout.css?ver=1.2">
...
<body>
    ...
    <div class="wrapper ">
            ...
            <div class="checkoutSummary ">
                <div class="row">
                    ...
                    <div class="col-md-4 my-4">
                        ...
                        <div class="my-5 d-grid gap-2 checkoutBtn">
        ...
        <script src="{{ URL::asset('/js/p-checkout.js?ver=1.7') }}"></script>
        <!-- <script src='http://127.0.0.1/s/s/controller/js/p-checkout.js?ver=1.6'></script> -->
