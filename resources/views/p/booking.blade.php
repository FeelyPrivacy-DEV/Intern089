                    ...
                    <div class="col-md-12 my-4">
                        ...
                        <div class="row bookingDates">
                            ...
                            <div class="container protopay d-flex justify-content-end">
                                ...
                                <button class="btn btn-primary px-3 py-2 " onclick="proccedtopay()" id="proccedtopay">Proceed to Pay<i class="bi bi-arrow-right my-auto mx-3 "></i></button>
                            </div>
                        </div>
                    </div>
