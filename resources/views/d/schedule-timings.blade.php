...
<div class="row p-5">
    <div class="col-md-3 side-profile p-2 ">
        ...
        <ul class="px-0">
                <li class=""><a href="/d"><i class="bi bi-speedometer"></i>Dashboard</a></li>
                <li class=""><a href="/d/appointments"><i class="bi bi-calendar-check-fill"></i>Appointments</a></li>
                <!-- <li class=""><a href="#"><i class="bi bi-person-lines-fill"></i>My Patients</a></li> -->
                <li class=""><a href="/d/schedule-timings" class="s-active"><i class="bi bi-hourglass-split"></i>Schedule Timimg</a></li>
                ...
                <!-- <li class=""><a href="/d/profile-settings"><i class="bi bi-gear-fill"></i>Profile Setting</a></li> -->
                <!-- <li class=""><a href="#"><i class="bi bi-share-fill"></i>Social Media</a></li> -->
                <li class=""><a href="/d/forgot-password"><i class="bi bi-lock-fill"></i>Change Password</a></li>
