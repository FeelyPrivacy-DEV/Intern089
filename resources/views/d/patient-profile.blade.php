...
<body>
    ...
    <div class="wrapper ">
        ...
        <div class=" d-dash-content pl-5">
            ...
            <div class="">
                <!-- sidebar -->
                <div class=" patientSideProfile side-profile ">
                    <div class="">
                        <p class="h5 my-2">Patient Details</p>
                        <div class="d-flex justify-content-center">
                            ...
                            if ($record['profile_image'] != '') {
                                echo '<img src="/image/doc-img/doc-img/' . $record['profile_image'] . '" class="rounded" height="60" alt="User Image">';
                            } else {
                                echo '<img src="/image/doc-img/doc-img/default-doc.jpg" height="60" alt="User Image">';
                            }
                            ?>
                        </div>
                ...
                <div class=" patientDetailsTable ">
                    <div id="allTablesWithNav"> 
                        <div class="my-4">
                            <nav class="nav d-flex justify-content-around ">
                                <button class="btn px-4 pb-2 active ">Appointments</button>
                                <button class="btn px-4 pb-2 ">Prescriptions</button>
                                <button class="btn px-4 pb-2 ">Medical_Records</button>
                                <button class="btn px-4 pb-2 ">Billing</button>
                            </nav>
                            <hr class="mx-3">
                        </div>
                        <div class="my-2">
                    ...
                    <div class="py-3" id="add-prescription">
                        ...
                        <div class="d-flex justify-content-start mt-4">
                            <div class="d-flex pres-reason">
                                <label for="text" class="form-label text-primary text-nowrap my-auto">Chief Complaints <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="prescription-reason" required>
                            </div>
                            <div class="d-flex diagnosis mx-2">
                                <label for="text" class="form-label text-primary text-nowrap my-auto">Diagnosis <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="prescription-diagnosis" required>
                            </div>
