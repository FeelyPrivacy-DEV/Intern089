...
function proccedtopay() {
    ...
    var url = 'http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/controller/php/add_e.php';
    ...
    xhr.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200) {
            ...
            window.location.href = `http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/checkout?id=${doc_id}&t=${s_time}&d=${date}`;
        }
    };  
