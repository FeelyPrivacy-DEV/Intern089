...
require '../../vendor/autoload.php';
    ...
    if(isset($_POST['add_m_meeting'])) {
        ...
        header('location: https://test.feelyprivacy.comprivacy.com/s/view/d/schedule-timings?slot=submit');
        ...
        header('location: https://test.feelyprivacy.comprivacy.com/s/view/d/profile-settings');
        ...
        if($send == true) {
            ...
            header( 'location: https://test.feelyprivacy.comprivacy.com/s/view/index/index?email=err' );
        }
    } 
                        ...
                        foreach($singleVal as $date=>$val) {
                            if($date == date('Y-m-d')) {
                                foreach($val as $k=>$v) {
                                    ...
                                    echo'<tr class="py-5">
                                            <td class="d-flex pat">
                                                <img src="https://test.feelyprivacy.comprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="my-auto" height="40" alt="" srcset="">
                                                        ...
                                                        <div class="modal-body p-5">
                                                            <div class="p-3 d-flex justify-content-between my-2 ">
                                                                <div class="d-flex pet-info">
                                                                    <div class="pat-img">
                                                                        <img src="https://test.feelyprivacy.comprivacy.com/s/public/image/pat-img/default_user.png" height="110" width="110"
                                                                            alt="" srcset="">
                                                                    </div>
