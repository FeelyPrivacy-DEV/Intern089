...
if(isset($_POST['manager_signup'])) {
    ...
    if($responseData->success) {
        ...
        header('location: http://test.com/s/s/d?login=now');
        // echo 'Account created success';
    } 
    else {
        header('location: http://test.com/s/s/d?c=e');
    ...
    if($responseData->success) {
        ...
        header('location: http://test.com/s/s/p?login=now');
    }
    else {
        header('location: http://test.com/s/s/p?c=e');
