            ...
            <div class='container-fluid'>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <!-- <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/">Home</a>
                        </li> -->
                    </ul>
                    ...
                    <div class="btn-group dropdown mx-5">
                        ...
                        <ul class="dropdown-menu dropdown-right" aria-labelledby="navbarDarkDropdownMenuLink">
                            ...
                            <hr>
                            <li>
                                <form action='http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/controller/php/logout.php' method='POST'>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/d" class='btn btn-outline-primary text-primary px-3 py-2 mx-5'>LOGIN /
                SIGNUP</a>
        </div>
    </div>
</nav>
