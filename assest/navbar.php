    ...
    <div class='container-fluid'>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="http://143.110.176.130/s/view/">Home</a>
                </li>
            </ul>
            <form action='http://143.110.176.130/s/controller/php/logout.php' method='POST'>
