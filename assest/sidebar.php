...
<div class="col-md-3 side-profile p-2 ">
    <div class="">
        <div class="d-flex justify-content-center mb-4">
            <img src="http://pavan.co/s/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded-circle" alt="">
        </div>
    ...
    <div class="side-nav my-4">
        <ul class="px-0">
            ...
            <li class=""><a href="http://pavan.co/s/s/view/d/doctor-profile-settings"><i class="bi bi-gear-fill"></i>Profile Setting</a></li>
