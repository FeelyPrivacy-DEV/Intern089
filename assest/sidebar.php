...
<div class="col-md-3 side-profile p-2 ">
    <div class="">
        <div class="d-flex justify-content-center mb-4">
            <img src="https://test.feelyprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded-circle" alt="">
        </div>
    ...
    <div class="side-nav my-4">
        <ul class="px-0">
            <li class=""><a href="#" class="s-active" ><i class="bi bi-speedometer"></i>Dashboard</a></li>
            <li class=""><a href="#"><i class="bi bi-calendar-check-fill"></i>Appointments</a></li>
            <li class=""><a href="#"><i class="bi bi-person-lines-fill"></i>My Patients</a></li>
            <li class=""><a href="#"><i class="bi bi-hourglass-split"></i>Schedule Timimg</a></li>
            ...
            <li class=""><a href="https://test.feelyprivacy.com/s/view/d/doctor-profile-settings"><i class="bi bi-gear-fill"></i>Profile Setting</a></li>
