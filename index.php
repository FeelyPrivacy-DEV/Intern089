...
<body>
    ...
    <?php
        ...
        // 'redirect_uri' => 'http://143.244.139.242/s/index',
    ...
    <div class="container formcont my-5">
        <div class="reg_cont d-flex justify-content-center">
            <div class="img my-auto mx-4">
                <img src="http://143.244.139.242/s/public/image/login-banner.png" class="bnar" height="300" alt="" srcset="">
            </div>
            ...
            <div class="forms mx-4">
                <div class="reg" id="docreg">
                    <div class="d-flex justify-content-between px-3 pb-2">
                        ...
                        <!-- <a href="http://143.244.139.242/s/p">Not a Doctor ?</a> -->
                    </div>
                ...
                <!-- <div class="login-container" id="docreg">
                    ...
                    <div class="col-xs-12 col-sm-4 col-sm-offset-4 login-box">
                        <div class="login-header mb-3">
                            <img src="http://143.244.139.242/s/public/image/logo.png" />
                        </div>
    ...
    <script src='http://143.244.139.242/s/controller/js/index.js?ver=1.4'></script>
