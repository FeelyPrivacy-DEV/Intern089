...
<body>
    ...
    <?php
        ...
        // 'redirect_uri' => 'http://test.feelyprivacy.com/s/index',
            ...
            <div class="forms mx-4">
                <div class="reg" id="docreg">
                    <div class="d-flex justify-content-between px-3 pb-2">
                        ...
                        <a href="http://test.feelyprivacy.com/s/p">Not a Doctor ?</a>
                    </div>
                ...
                <!-- <div class="login-container" id="docreg">
                    ...
                    <div class="col-xs-12 col-sm-4 col-sm-offset-4 login-box">
                        <div class="login-header mb-3">
                            <img src="http://test.feelyprivacy.com/s/public/image/logo.png" />
                        </div>
    ...
    <script>
        ...
        //     var callbackURL = 'http://test.feelyprivacy.com/s/index';
        ...
        //     var databaseConnection = 'mongodb://test.feelyprivacy.com:27017';
