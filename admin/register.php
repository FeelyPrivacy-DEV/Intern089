                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <!-- Form -->
                            <form action="http://143.110.176.130/s/admin/controller/php/signup.php" method="POST">
                                <div class="row my-3">
                                    <div class="col-md-6">
                            ...
                            <div class="text-center dont-have" >Already have an account? <a href="http://143.110.176.130/s/admin/index">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
