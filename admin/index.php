                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <!-- Form -->
                            <form action="http://pavan.co/s/s/admin/controller/php/login.php" method="POST">
                            ...
                            <div class="text-center dont-have" >Don’t have an account? <a href="http://pavan.co/s/s/admin/register">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
