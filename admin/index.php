...
<head>
    ...
    <link rel="stylesheet" href="http://143.110.176.130/s/admin/public/stylesheet/login.css?ver=1.1">
    <title>Admin </title>
</head>
            ...
            <div class="container">
                <div class="loginbox">
                    <div class="login-left">
                        <img class="img-fluid" src="http://143.110.176.130/s/admin/public/image/logo.png" alt="Logo">
                    </div>
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <!-- Form -->
                            <form action="http://143.110.176.130/s/admin/controller/php/login.php" method="POST">
                            ...
                            <div class="text-center dont-have" >Don’t have an account? <a href="http://143.110.176.130/s/admin/register">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
