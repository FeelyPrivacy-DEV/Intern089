...
<head>
    ...
    <link rel="stylesheet" href="http://143.110.176.130/s/admin/public/stylesheet/dashboard.css?ver=1.6">
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="http://143.110.176.130/s/admin/view/appoinment" class="nav-link active-sn "
                        aria-current="page">
