...
<head>
    ...
    <link rel="stylesheet" href="http://test.feelyprivacy.com/s/admin/public/stylesheet/dashboard.css?ver=1.6">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="http://test.feelyprivacy.com/s/admin/view/appoinment" class="nav-link active-sn "
                        aria-current="page">
    ...
    <script src='http://test.feelyprivacy.com/s/admin/controller/js/dashboard.js?ver=1.5'></script>
