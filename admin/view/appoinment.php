...
<head>
    ...
    <link rel="stylesheet" href="https://test.feelyprivacy.com/s/admin/public/stylesheet/dashboard.css?ver=1.6">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            <a href="https://test.feelyprivacy.com/s/admin/view/index"
                class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                <img src="https://test.feelyprivacy.com/s/admin/public/image/logo.png" height="40" class="mx-auto " alt="">
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li>
                    <a href="https://test.feelyprivacy.com/s/admin/view/index" class="nav-link link-dark">
                        <i class="bi bi-speedometer bi me-2"></i>
                        Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a href="https://test.feelyprivacy.com/s/admin/view/appoinment" class="nav-link active-sn "
                        aria-current="page">
                ...
                <li>
                    <a href="https://test.feelyprivacy.com/s/admin/view/specialities" class="nav-link link-dark">
                        <i class="bi bi-megaphone-fill bi me-2"></i>
                        Specialities
                    </a>
                </li>
                <li>
                    <a href="https://test.feelyprivacy.com/s/admin/view/doctor" class="nav-link link-dark">
                ...
                <li>
                    <a href="https://test.feelyprivacy.com/s/admin/view/patient" class="nav-link link-dark">
            ...
            <div class="container-fluid">
                ...
                <div class="btn-group dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li>
                            <form action='https://test.feelyprivacy.com/s/admin/controller/php/logout.php' method='POST'>
                                                        ...
                                                        echo '<tr class="px-auto">
                                                                    ...
                                                                    <h2 class="table-avatar">
                                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                                                ...
                                                                                if($record_doc_app['profile_image'] != '') {
                                                                                    echo 'src="https://test.feelyprivacy.com/s/public/image/doc-img/doc-img/'.$record_doc_app['profile_image'].'"';
                                                                                }
                                                                                else {
                                                                                    echo 'src="https://test.feelyprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg"';
                                                                                }
                                                                        echo 'height="40"
                                                                                alt="User Image"></a>
                                                                ...
                                                                <td>
                                                                    <h2 class="table-avatar">
                                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                                                class="avatar-img rounded-circle"
                                                                                src="https://test.feelyprivacy.com/s/admin/public/image/ad.jpg"
                                                                                height="40"
                                                                                alt="User Image"></a>
    ...
    <script src='https://test.feelyprivacy.com/s/admin/controller/js/dashboard.js?ver=1.5'></script>
