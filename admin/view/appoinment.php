...
<head>
    ...
    <link rel="stylesheet" href="https://test.feelyprivacy.comprivacy.com/s/admin/public/stylesheet/dashboard.css?ver=1.6">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li>
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/index" class="nav-link link-dark">
                        <i class="bi bi-speedometer bi me-2"></i>
                        Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/appoinment" class="nav-link active-sn "
                        aria-current="page">
    ...
    <script src='https://test.feelyprivacy.comprivacy.com/s/admin/controller/js/dashboard.js?ver=1.5'></script>
