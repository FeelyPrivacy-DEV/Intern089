...
<head>
    ...
    <link rel="stylesheet" href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/admin/public/stylesheet/dashboard.css?ver=1.2">
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/admin/view/patient" class="nav-link active-sn" aria-current="page">
