...
<head>
    ...
    <link rel="stylesheet" href="https://test.feelyprivacy.com/s/admin/public/stylesheet/dashboard.css?ver=1.2">
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="https://test.feelyprivacy.com/s/admin/view/patient" class="nav-link active-sn" aria-current="page">
