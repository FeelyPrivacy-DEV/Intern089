...
<head>
    ...
    <link rel="stylesheet" href="http://pavan.co/s/s/admin/public/stylesheet/dashboard.css?ver=1.2">
...
<body>
    ...
    <script src='http://pavan.co/s/s/admin/controller/js/dashboard.js?ver=2.0'></script>
