    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="https://test.feelyprivacy.com/s/admin/view/index" class="nav-link active-sn" aria-current="page">
                        <i class="bi bi-speedometer bi me-2"></i>
                        Dashboard
                    </a>
                </li>
                <li>
                    <a href="https://test.feelyprivacy.com/s/admin/view/appoinment" class="nav-link link-dark">
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="#" class="avatar avatar-sm mr-2"><img
                                                        ...
                                                        src="https://test.feelyprivacy.com/s/public/image/pat-img/default_user.png"
                                                        height="40" alt="User Image"></a>
