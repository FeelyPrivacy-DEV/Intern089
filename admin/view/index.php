...
<head>
    ...
    <link rel="stylesheet" href="http://pavan.co/s/s/admin/public/stylesheet/dashboard.css?ver=2.9">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="http://pavan.co/s/s/admin/view/index" class="nav-link active-sn" aria-current="page">
                ...
                <li>
                    <a href="http://pavan.co/s/s/admin/view/pending_doc" class="nav-link link-dark">
                                                ...
                                                echo '<td>
                                                        ...
                                                        if($key['profile_image'] != '') {
                                                            echo '<a href="#" class="avatar avatar-sm mr-2"><img
                                                                        ...
                                                                        src="http://pavan.co/s/s/public/image/doc-img/doc-img/'.$key['profile_image'].'"
                                                            ...
                                                            echo '<a href="#" class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="http://pavan.co/s/s/public/image/doc-img/doc-img/default-doc.jpg"
                                                                        height="40" alt="User Image"></a>
                                                                <a href="#">Dr. '.$key['fname'].' '.$key['sname'].'</a>';
                                                        }
                                                echo '</h2>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="#" class="avatar avatar-sm mr-2"><img
                                                        class="avatar-img rounded-circle"
                                                        src="http://pavan.co/s/s/public/image/pat-img/default_user.png"
                                                        height="40" alt="User Image"></a>
                                                        ...
                                                        echo '<tr class="px-auto">
                                                                    ...
                                                                    <h2 class="table-avatar">
                                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                                                ...
                                                                                if($record_doc_app['profile_image'] != '') {
                                                                                    echo 'src="http://pavan.co/s/s/public/image/doc-img/doc-img/'.$record_doc_app['profile_image'].'"';
                                                                                }
                                                                                else {
                                                                                    echo 'src="http://pavan.co/s/s/public/image/doc-img/doc-img/default-doc.jpg"';
                                                                                }
                                                                        echo 'height="40"
                                                                                alt="User Image"></a>
                                                                ...
                                                                <td>
                                                                    <h2 class="table-avatar">
                                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                                                class="avatar-img rounded-circle"
                                                                                src="http://pavan.co/s/s/admin/public/image/ad.jpg"
                                                                                height="40"
                                                                                alt="User Image"></a>
    ...
    <script src='http://pavan.co/s/s/admin/controller/js/dashboard.js?ver=1.8'></script>
