<?php
    ...
    if($_SESSION['aid'] == '') {
        header('location: https://test.feelyprivacy.comprivacy.com/s/admin/index');
    }
...
<head>
    ...
    <link rel="stylesheet" href="https://test.feelyprivacy.comprivacy.com/s/admin/public/stylesheet/dashboard.css?ver=3.1">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/index"
                class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                <img src="https://test.feelyprivacy.comprivacy.com/s/admin/public/image/logo.png" height="40" class="mx-auto " alt="">
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/index" class="nav-link active-sn" aria-current="page">
                        <i class="bi bi-speedometer bi me-2"></i>
                        Dashboard
                    </a>
                </li>
                <li>
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/appoinment" class="nav-link link-dark">
                        <i class="bi bi-calendar-check-fill bi me-2"></i>
                        Appointments
                    </a>
                </li>
                <li>
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/specialities" class="nav-link link-dark">
                        <i class="bi bi-megaphone-fill bi me-2"></i>
                        Specialities
                    </a>
                </li>
                <li>
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/doctor" class="nav-link link-dark">
                        <i class="bi bi-person-lines-fill bi me-2"></i>
                        Doctor
                    </a>
                </li>
                <li>
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/pending_doc" class="nav-link link-dark">
                ...
                <li>
                    <a href="https://test.feelyprivacy.comprivacy.com/s/admin/view/patient" class="nav-link link-dark">
            ...
            <div class="container-fluid">
                ...
                <div class="dropdown mx-5">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li>
                            <form action='https://test.feelyprivacy.comprivacy.com/s/admin/controller/php/logout.php' method='POST'>
                                                ...
                                                echo '<td>
                                                        ...
                                                        if($key['profile_image'] != '') {
                                                            echo '<a href="#" class="avatar avatar-sm mr-2"><img
                                                                        ...
                                                                        src="https://test.feelyprivacy.comprivacy.com/s/public/image/doc-img/doc-img/'.$key['profile_image'].'"
                                                            ...
                                                            echo '<a href="#" class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle mx-2"
                                                                        src="https://test.feelyprivacy.comprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg"
                                                                        height="40" alt="User Image"></a>
                                                                <a href="#" class="my-auto mx-1 text-nowrap">Dr. '.$key['fname'].' '.$key['sname'].'</a>';
                                                        }
                                                echo '</h2>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="#" class="avatar avatar-sm mr-2"><img
                                                        ...
                                                        src="https://test.feelyprivacy.comprivacy.com/s/public/image/pat-img/default_user.png"
                                                        height="40" alt="User Image"></a>
                                                        ...
                                                        echo '<tr class="px-auto">
                                                                    ...
                                                                    <h2 class="table-avatar d-flex justify-content-start">
                                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                                                ...
                                                                                if($record_doc_app['profile_image'] != '') {
                                                                                    echo 'src="https://test.feelyprivacy.comprivacy.com/s/public/image/doc-img/doc-img/'.$record_doc_app['profile_image'].'"';
                                                                                }
                                                                                else {
                                                                                    echo 'src="https://test.feelyprivacy.comprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg"';
                                                                                }
                                                                        echo 'height="40"
                                                                                alt="User Image"></a>
                                                                ...
                                                                <td>
                                                                    <h2 class="table-avatar">
                                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img
                                                                                class="avatar-img rounded-circle"
                                                                                src="https://test.feelyprivacy.comprivacy.com/s/admin/public/image/ad.jpg"
                                                                                height="40"
                                                                                alt="User Image"></a>
    ...
    <script src='https://test.feelyprivacy.comprivacy.com/s/admin/controller/js/dashboard.js?ver=1.8'></script>
