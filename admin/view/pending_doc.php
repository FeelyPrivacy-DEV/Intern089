...
<head>
    ...
    <link rel="stylesheet" href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/admin/public/stylesheet/dashboard.css?ver=2.5">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/admin/view/pending_doc" class="nav-link text-nowrap active-sn"
                        aria-current="page">
    ...
    <script src='http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/admin/controller/js/dashboard.js?ver=1.7  '></script>
