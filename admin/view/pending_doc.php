...
<head>
    ...
    <link rel="stylesheet" href="http://143.110.176.130/s/admin/public/stylesheet/dashboard.css?ver=2.5">
...
<body>
    ...
    <div class="main">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="http://143.110.176.130/s/admin/view/pending_doc" class="nav-link text-nowrap active-sn"
                        aria-current="page">
    ...
    <script src='http://143.110.176.130/s/admin/controller/js/dashboard.js?ver=1.7  '></script>
