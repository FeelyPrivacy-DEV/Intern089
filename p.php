    ...
    <div class="container  my-5">
        <div class="reg_cont d-flex justify-content-center">
            <div class="img my-auto mx-4">
                <img src="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/public/image/login-banner.png" height="300" alt="" srcset="">
            </div>
            <div class="forms mx-4">
                <div class="reg" id="patreg">
                    <div class="d-flex justify-content-between px-3 pb-2">
                        <h5>Patient Register</h5>
                        <a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/index">Not a Patient ?</a>
                    </div>
