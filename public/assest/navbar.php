    ...
    if($_SESSION['email'] != '') {
        ...
        <nav class='navbar navbar-expand-lg navbar-primary bg-primary '>
            <div class='container-fluid'>
                <a class='navbar-brand text-light mx-4' href='http://127.0.0.1/s/s/'>
                    <img src="http://127.0.0.1/s/s/public/image/logo.png" height="60" alt="" srcset="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="btn-group dropdown mx-5">
                        ...
                        <ul class="dropdown-menu dropdown-right" aria-labelledby="navbarDarkDropdownMenuLink">
                            ...
                            <hr>
                            <li>
                                <form action='http://127.0.0.1/s/s/controller/php/logout.php' method='POST'>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="http://127.0.0.1/s/s/d" class='btn btn-outline-primary text-primary px-3 py-2 mx-5'>LOGIN /
                SIGNUP</a>
        </div>
    </div>
</nav>
