...
<body>
        ...
        <div class="col-md-3 side-profile p-2 border">
            <div class="">
                <div class="d-flex justify-content-center mb-4">
                    <img src="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/public/image/pat-img/default_user.png" height="150" class="rounded-circle"
                        alt="">
                </div>  
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                <li class="px-4"><a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/index" ><i class="bi bi-person-bounding-box"></i>Select Doctor</a></li>
                    <li class="px-4"><a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/dashboard"  class="s-active"><i class="bi bi-speedometer"></i>Dashboard</a></li>
                    <!-- <li class="px-4"><a href="#"><i class="bi bi-bookmark-fill"></i></i>Favouriate</a></li> -->
                    <!-- <li class="px-4"><a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/booking"><i class="bi bi-chat-left-dots-fill"></i>Booking</a></li> -->
                    <!-- <li class="px-4"><a href="#"><i class="bi bi-chat-left-dots-fill"></i>Message</a></li> -->
                    <li class="px-4"><a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/profile-settings"><i class="bi bi-gear-fill"></i>Profile Setting</a></li>
                                            ...
                                            foreach($date as $key=>$val) {
                                                foreach($val as $k=>$v) {
                                                    ...
                                                    echo'<tr class="py-5">
                                                            ...
                                                            echo '<form action="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/doctor-profile" method="POST">
    ...
    <script src='http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/controller/js/p-dashboard.js?ver=1.3'></script>
