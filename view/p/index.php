...
<body>
        ...
        <div class="col-md-3 side-profile p-2 border">
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    ...
                    <!-- <li class="px-4"><a href="http://test.feelyprivacy.com/s/view/p/booking"><i
                                ...
                                <div class="container my-5">
                                    <div class="p-2 d-flex doc_block justify-content-between">
                                        <div class="left d-flex">
                                            <img src="http://test.feelyprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded all_doc_img"
                                            ...
                                            <div class="mx-3">
                                                ...
                                                <div class="d-flex">
                                                    <img src="http://test.feelyprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="px-2"
                                        ...
                                        <div class="right">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="http://test.feelyprivacy.com/s/view/p/doctor-profile?id=<?php echo $docval['d_unid']; ?>" class="btn btn-outline-primary px-5 py-2 mt-2" type="button">View Profile</a>

                                                <?php
                                                    if($_SESSION['eid'] != '') {
                                                        echo '<a href="http://test.feelyprivacy.com/s/view/p/booking?id='.$docval['d_unid'].'" class="btn btn-primary px-5 py-2 mt-2" type="button">BOOK <br>APPOINMENT</a>';
                                                    }
                                                    else {
    ...
    <script src='http://test.feelyprivacy.com/s/controller/js/p-dashboard.js?ver=2.5'></script>
</body>
