...
<head>
    ...
    <link rel="stylesheet" href="http://143.244.139.242/s/public/stylesheet/p-dashboard.css?ver=1.6">
...
<body>
    ...
    <div class="m-2 row">
        ...
        <div class="col-md-3 side-profile p-2 border">
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    <li class="px-4"><a href="http://143.244.139.242/s/view/p/index" class="s-active"><i
                    ...
                    <!-- <li class="px-4"><a href="http://143.244.139.242/s/view/p/booking"><i
                                ...
                                <div class="container my-5">
                                    <div class="p-2 d-flex doc_block justify-content-between">
                                        <div class="left d-flex">
                                            <img src="http://143.244.139.242/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded all_doc_img"
                                        ...
                                        <div class="right">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="http://143.244.139.242/s/view/p/doctor-profile?id=<?php echo $docval['d_unid']; ?>" class="btn btn-outline-primary px-5 py-2 mt-2" type="button">View Profile</a>

                                                <?php
                                                    if($_SESSION['eid'] != '') {
                                                        echo '<a href="http://143.244.139.242/s/view/p/booking?id='.$docval['d_unid'].'" class="btn btn-primary px-5 py-2 mt-2" type="button">BOOK <br>APPOINMENT</a>';
                                                    }
                                                    else {
    ...
    <script src='http://143.244.139.242/s/controller/js/p-dashboard.js?ver=2.5'></script>
</body>
