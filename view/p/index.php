...
<body>
                                ...
                                <div class="container my-5">
                                    <div class="p-2 d-flex doc_block justify-content-between">
                                        <div class="left d-flex">
                                            <img src="https://test.feelyprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded all_doc_img"
                                        ...
                                        <div class="right">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="https://test.feelyprivacy.com/s/view/p/doctor-profile?id=<?php echo $docval['d_unid']; ?>" class="btn btn-outline-primary px-5 py-2 mt-2" type="button">View Profile</a>

                                                <?php
                                                    if($_SESSION['eid'] != '') {
                                                        echo '<a href="https://test.feelyprivacy.com/s/view/p/booking?id='.$docval['d_unid'].'" class="btn btn-primary px-5 py-2 mt-2" type="button">BOOK <br>APPOINMENT</a>';
                                                    }
                                                    else {
    ...
    <script src='https://test.feelyprivacy.com/s/controller/js/p-dashboard.js?ver=2.5'></script>
</body>
