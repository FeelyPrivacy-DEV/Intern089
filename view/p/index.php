...
<body>
        ...
        <div class="col-md-3 side-profile p-2 ">
            <div class="">
                <div class="d-flex justify-content-center mb-4">
                    <img src="http://localhost/s/s/public/image/pat-img/default_user.png" height="150" class="rounded-circle"
                        alt="">
                </div>  
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    <li class="px-4"><a href="http://localhost/s/s/view/p/index"  class="s-active"><i class="bi bi-speedometer"></i>Dashboard</a></li>
                    <li class="px-4"><a href="#"><i class="bi bi-bookmark-fill"></i></i>Favouriate</a></li>
                    <li class="px-4"><a href="http://localhost/s/s/view/p/booking"><i class="bi bi-chat-left-dots-fill"></i>Booking</a></li>
                    <li class="px-4"><a href="#"><i class="bi bi-chat-left-dots-fill"></i>Message</a></li>
                    <li class="px-4"><a href="http://localhost/s/s/view/p/profile-settings"><i class="bi bi-gear-fill"></i>Profile Setting</a></li>
                                                    ...
                                                    echo'<tr class="py-5">
                                                            <td class="d-flex pat">';
                                                                    if($doc_detail['profile_image'] != '') {
                                                                        echo '<img src="http://localhost/s/s/public/image/doc-img/doc-img/'.$doc_detail['profile_image'].'" class="my-auto" height="40" alt="User Image">';
                                                                    }
                                                                    else {
    ...
    <script src='http://localhost/s/s/controller/js/p-dashboard.js?ver=1.2'></script>
