...
<head>
    ...
    <link rel="stylesheet" href="http://128.199.27.158/s/public/stylesheet/p-dashboard.css?ver=1.4">
...
<body>
        ...
        <div class="col-md-3 side-profile p-2 border">
            <div class="">
                <div class="d-flex justify-content-center mb-4">
                    <img src="http://128.199.27.158/s/public/image/pat-img/default_user.png" height="150" class="rounded-circle"
                        alt="">
                </div>  
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    <li class="px-4"><a href="http://128.199.27.158/s/view/p/index"  class="s-active"><i class="bi bi-speedometer"></i>Dashboard</a></li>
                    <li class="px-4"><a href="#"><i class="bi bi-bookmark-fill"></i></i>Favouriate</a></li>
                    <li class="px-4"><a href="http://128.199.27.158/s/view/p/booking"><i class="bi bi-chat-left-dots-fill"></i>Booking</a></li>
                    <li class="px-4"><a href="#"><i class="bi bi-chat-left-dots-fill"></i>Message</a></li>
                    <li class="px-4"><a href="http://128.199.27.158/s/view/p/profile-settings"><i class="bi bi-gear-fill"></i>Profile Setting</a></li>
                                                    ...
                                                    echo'<tr class="py-5">
                                                            <td class="d-flex pat">';
                                                                    if($doc_detail['profile_image'] != '') {
                                                                        echo '<img src="http://128.199.27.158/s/public/image/doc-img/doc-img/'.$doc_detail['profile_image'].'" class="my-auto" height="40" alt="User Image">';
                                                                    }
                                                                    else {
                                                                        echo '<img src="http://128.199.27.158/s/public/image/doc-img/doc-img/default-doc.jpg" class="my-auto" height="40" alt="User Image">';
                                                                    }
                                                            echo '<form action="http://128.199.27.158/s/view/p/doctor-profile" method="POST">
    ...
    <script src='http://128.199.27.158/s/controller/js/p-dashboard.js?ver=1.2'></script>
