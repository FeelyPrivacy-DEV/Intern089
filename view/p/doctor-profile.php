...
<head>
    ...
    <link rel="stylesheet" href="http://test.feelyprivacy.com/s/public/stylesheet/p-doctor-profile.css?ver=1.2">
    ...
    <div class="container my-5">
        <div class="p-2 d-flex doc_block justify-content-between">
            <div class="left d-flex">
                <img src="http://test.feelyprivacy.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded doc_img"
            ...
            <div class="right">
                ...
                <?php
                        if($_SESSION['eid'] != '') {
                        echo '<a href="http://test.feelyprivacy.com/s/view/p/booking?id='.$record['d_unid'].'" class="btn btn-primary px-5 py-2 mt-2 book_now" type="button">BOOK <br>APPOINMENT</a>';
                    }
                    else {
