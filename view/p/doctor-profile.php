<?php
    ...
    $collection = $db->manager;
    $record = $collection->findOne( [ 'd_unid' =>$_POST['doc_profile_id']] );
...
<head>
    ...
    <link rel="stylesheet" href="http://143.244.135.9/s/public/stylesheet/p-doctor-profile.css?ver=1.1">
...
<body>
    ...
    <div class="container my-5">
        <div class="p-2 d-flex justify-content-between">
            <div class="left d-flex">
                <img src="http://143.244.135.9/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded"
                ...
                <div class="mx-3">
                    ...
                    <div class="d-flex">
                        <img src="http://143.244.135.9/s/public/image/doc-img/doc-img/default-doc.jpg" class="px-2"
            ...
            <div class="right">
                ...
                <?php
                    if($_SESSION['eid'] != '') {
                        echo '<a href="" class="btn btn-primary px-5 py-2 mt-2" type="button">BOOK <br>APPOINMENT</a>';
                    }
                    else {
    ...
    <script src='http://143.244.135.9/s/controller/js/d-patient-profile.js?ver=1.2'></script>
