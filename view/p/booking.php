...
<head>
    ...
    <link rel="stylesheet" href="http://test.com/s/s/public/stylesheet/p-booking.css?ver=1.1">
...
<body>
        ...
        <div class="col-md-3 side-profile p-2 ">
            <div class="">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <img src="http://test.com/s/s/public/image/pat-img/default_user.png" height="150"
    ...
    <script src="http://test.com/s/s/controller/js/p-booking.js?ver=2.2"></script>
    <script src="http://test.com/s/s/controller/js/success.js?ver=2.0"></script>
</body>
