...
<head>
    ...
    <link rel="stylesheet" href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/public/stylesheet/p-booking.css?ver=1.4">
    ...
    <div class="m-2 row my-5">
        ...
        <div class="col-md-3 side-profile p-2 ">
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    ...
                    <!-- <li class="px-4"><a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/p/booking" class="s-active"><i
        ...
        <div class="col-md-9 d-book-content my-4">
            <div class="left d-flex mb-4">
                <img src="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/public/image/doc-img/doc-img/default-doc.jpg" class="rounded" height="90"
                    alt="User Image">
                <div class="mx-3">
        ...
        <script src="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/controller/js/p-booking.js?ver=2.8"></script>
        <script src="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/controller/js/success.js?ver=2.0"></script>
</body>
