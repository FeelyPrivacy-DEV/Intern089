...
<head>
    ...
    <link rel="stylesheet" href="http://143.244.135.9/s/public/stylesheet/d-appointments.css?ver=1.0">
...
<body>
        ...
        <div class="col-md-3 side-profile p-2">
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    ...
                    <li class="px-4"><a href="http://143.244.135.9/s/view/d/appointments" class="s-active"><i
    ...
    <script src='http://143.244.135.9/s/controller/js/d-appointments.js?ver=1.0'></script>
