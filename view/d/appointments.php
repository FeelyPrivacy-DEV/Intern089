...
<head>
    ...
    <link rel="stylesheet" href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/public/stylesheet/d-appointments.css?ver=1.3">
...
<body>
        ...
        <div class="col-md-3 side-profile p-2">
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    ...
                    <li class="px-4"><a href="http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/view/d/appointments" class="s-active"><i
    ...
    <script src='http://ec2-13-127-72-12.ap-south-1.compute.amazonaws.com/s/controller/js/d-appointments.js?ver=1.3'></script>
