...
<head>
    ...
    <link rel="stylesheet" href="http://143.244.139.242/s/public/stylesheet/d-dashboard.css?ver=1.1">
...
<body>
                                                        ...
                                                        foreach($val as $k=>$v) {
                                                            ...
                                                            echo'<tr class="py-5">
                                                                    <td class="d-flex pat">
                                                                        ...
                                                                        <form action="http://143.244.139.242/s/view/d/patient-profile" method="POST">
    ...
    <script src='http://143.244.139.242/s/controller/js/d-dashboard.js?ver=1.2'></script>
