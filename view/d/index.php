    ...
    <div class="m-5 row">
        ...
        <div class="col-md-3 side-profile p-2 ">
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    <li class="px-4"><a href="http://pavan.co/s/s/view/d/index"  class="s-active"><i
                    ...
                    <li class="px-4"><a href="http://pavan.co/s/s/view/d/profile-settings"><i
        ...
        <div class="col-md-9 d-dash-content pl-5">
            <div class="row d-flex justify-content-between short-data">
                <div class="col-md-3 m-4">
                    <div class="d-flex">
                        <img src="http://pavan.co/s/s/public/image/doc-img/icon-01.png" class="p-4" alt="" srcset="">
                ...
                <div class="col-md-3 m-4 ">
                    <div class="d-flex">
                        <img src="http://pavan.co/s/s/public/image/doc-img/icon-02.png" class="p-4" alt="" srcset="">
                ...
                <div class="col-md-3 m-4 ">
                    <div class="d-flex ">
                        <img src="http://pavan.co/s/s/public/image/doc-img/icon-03.png" class="p-4" alt="" srcset="">
                        <div class="px-3 my-auto d-flex flex-column justify-content-start">
