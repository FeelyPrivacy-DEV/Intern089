...
<head>
    ...
    <link rel="stylesheet" href="http://143.110.176.130/s/public/stylesheet/d-dashboard.css?ver=1.1">
...
<body>
    ...
    <div class="m-5 row">
        ...
        <div class="col-md-3 side-profile p-2 ">
            <div class="">
                ...
                <?php
                        if($record['profile_image'] != '') {
                            echo '<img src="http://143.110.176.130/s/public/image/doc-img/doc-img/'.$record['profile_image'].'" class="rounded" height="160" alt="User Image">';
                        }
                        else {
                            echo '<img src="http://143.110.176.130/s/public/image/doc-img/doc-img/default-doc.jpg" height="160" alt="User Image">';
                        }
                    ?>
                </div>
            ...
            <div class="side-nav my-4">
                <ul class="px-0">
                    <li class="px-4"><a href="http://143.110.176.130/s/view/d/index"  class="s-active"><i
                    ...
                    <li class="px-4"><a href="http://143.110.176.130/s/view/d/profile-settings"><i
        ...
        <div class="col-md-9 d-dash-content pl-5">
            <div class="row d-flex justify-content-between short-data">
                <div class="col-md-3 m-4">
                    <div class="d-flex">
                        <img src="http://143.110.176.130/s/public/image/doc-img/icon-01.png" class="p-4" alt="" srcset="">
                ...
                <div class="col-md-3 m-4 ">
                    <div class="d-flex">
                        <img src="http://143.110.176.130/s/public/image/doc-img/icon-02.png" class="p-4" alt="" srcset="">
                ...
                <div class="col-md-3 m-4 ">
                    <div class="d-flex ">
                        <img src="http://143.110.176.130/s/public/image/doc-img/icon-03.png" class="p-4" alt="" srcset="">
                        <div class="px-3 my-auto d-flex flex-column justify-content-start">
                                                        ...
                                                        foreach($val as $k=>$v) {
                                                            ...
                                                            echo'<tr class="py-5">
                                                                    <td class="d-flex pat">
                                                                        ...
                                                                        <form action="http://143.110.176.130/s/view/d/patient-profile" method="POST">
    ...
    <script src='http://143.110.176.130/s/controller/js/d-dashboard.js?ver=1.2'></script>
    <!-- <script src='http://143.110.176.130/s/controller/js/d-temp.js?ver=1.1'></script> -->
