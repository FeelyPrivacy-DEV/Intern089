...
<head>
    ...
    <link rel="stylesheet" href="http://128.199.27.158/s/public/stylesheet/d-profile-settings.css?ver=1.0">
...
<body>
    ...
    <div class="m-5 row">
        ...
        <div class="col-md-3 side-profile p-2 ">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <?php
                        if($record['profile_image'] != '') {
                            echo '<img src="http://128.199.27.158/s/public/image/doc-img/doc-img/'.$record['profile_image'].'" class="rounded" height="70" alt="User Image">';
                        }
                        else {
                            echo '<img src="http://128.199.27.158/s/public/image/doc-img/doc-img/default-doc.jpg" height="70" alt="User Image">';
                        }
                    ?>
                </div>                
            ...
            <ul class="px-0">
                    <li class="px-4"><a href="http://128.199.27.158/s/view/d/index"><i
                                class="bi bi-speedometer"></i>Dashboard</a></li>
                    <li class="px-4"><a href="http://128.199.27.158/s/view/d/appointments"><i
                    ...
                    <li class="px-4"><a href="http://128.199.27.158/s/view/d/schedule-timings"><i
                    ...
                    <li class="px-4"><a href="http://128.199.27.158/s/view/d/profile-settings"  class="s-active"><i
        ...
        <div class="col-md-9 content">
            <form action="http://128.199.27.158/s/controller/php/add_m.php" method="POST" enctype="multipart/form-data">
                <div class="">
                ...
                <div class="form-group">
                    <div class="change-avatar">
                        <div class="profile-img">
                            <?php
                                if($record['profile_image'] != '') {
                                    echo '<img src="http://128.199.27.158/s/public/image/doc-img/doc-img/'.$record['profile_image'].'" height="70" alt="User Image">';
                                }
                                else {
                                    echo '<img src="http://128.199.27.158/s/public/image/doc-img/doc-img/default-doc.jpg" height="70" alt="User Image">';
                                }
                ...
                <div class="clinki-info">
                    ...
                    <div class="clinic-img d-flex justify-content-start my-2">
                        <div class="upload-images m-1">
                            <img src="http://128.199.27.158/s/public/image/doc-img/clinic-img/feature-01.jpg" class="m-2"
                                height="80" alt="">
                            <a href="#" class="btn btn-icon btn-sm btn-danger"><i class="bi bi-trash"></i></a>
                        </div>
                        <div class="upload-images m-1">
                            <img src="http://128.199.27.158/s/public/image/doc-img/clinic-img/feature-02.jpg" class="m-2"
                                height="80" alt="">
                            <a href="#" class="btn btn-icon btn-sm btn-danger"><i class="bi bi-trash"></i></a>
                        </div>
                    </div>
    ...
    <script src='http://128.199.27.158/s/controller/js/d-profile-settings.js?ver=1.2'></script>
